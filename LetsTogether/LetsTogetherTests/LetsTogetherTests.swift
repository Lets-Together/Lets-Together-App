...
//
//    let exercise = Exercise(time: 5, labelML: "jumping-jack")
//    let bodyPontuatiion: BodyPontuationHelper
//    let viewModel: WorkoutScreenViewModel
//    var timeHelper = TimeHelper(timeToFinish: nil)
//
//    override init() {
//        self.bodyPontuatiion = BodyPontuationHelper(movementName: exercise.labelML!, percetage: 0.8)
//        self.viewModel = WorkoutScreenViewModel(bodyPose: BodyPoseHelper(), bodyPontuation: bodyPontuatiion, timer: TimeHelper(timeToFinish: exercise.time), exercise: exercise)
//    }
